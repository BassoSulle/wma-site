                            ...
                            <ul class="navbar-nav mr-auto nav-bottom-header justify-content-center d-flex col-12">
                                ...
                                <li class='nav-item dropdown'><a href='#'
                                    ...
                                    <ul class='dropdown-menu'>
                                        ...
                                        <li class='nav-item '>
                                            <a class='dropdown-item '
                                                href='{{ route('unit', ['language' => $current_language]) }}'>Unit
                                            </a>
                                        </li>
                                        <li class='nav-item '>
                                            <a class='dropdown-item '
                                ...
                                <li class='nav-item dropdown'><a href='#'
                                    ...
                                    <ul class='dropdown-menu'>
                                        ...
                                        @empty
                                            <li><a class='dropdown-item' href="#">No Forms avaliable</a>
                                            </li>
                                        @endforelse
                                    </ul>
                                </li>
                                ...
                                <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                    ...
                                    <ul class='dropdown-menu'>
                                        ...
                                        <li><a class='dropdown-item'
                                                href="{{ route('brochures', ['language' => $current_language]) }}">Brochures</a>
                                        </li>
                                        <li><a class='dropdown-item'
                                                href="{{ route('posters', ['language' => $current_language]) }}">Posters</a>
                                        </li>
                                        <li><a class='dropdown-item'
                                                href="{{ route('newsletter', ['language' => $current_language]) }}">News
                                                Letter</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                    ...
                                    <ul class='dropdown-menu'>
                                        ...
                                        @empty
                                            <li><a class='dropdown-item' href="#">No Publications avaliable</a>
                                            </li>
                                        @endforelse
                                    </ul>
                                </li>
