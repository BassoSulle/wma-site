                        ...
                        <div class="col-7 sm-hide px-0">
                            <ul class="list-inline mx-auto justify-content-end">
                                ...
                                <li class='nav-item'><a class='nav-link' target='_black'
                                        href='https://eoffice.gov.go.tz/users/login' style="color: white">e-Office</a>
                                </li>
                                </li>
                            ...
                            <ul class="navbar-nav mr-auto nav-bottom-header justify-content-center d-flex col-12">
                                ...
                                <li class='nav-item dropdown'><a href='#'
                                    ...
                                    <ul class='dropdown-menu'>
                                        ...
                                        <li class='nav-item '>
                                            <a class='dropdown-item '
                                                href='{{ route('unit', ['language' => $current_language]) }}'>VItengo
                                            </a>
                                        </li>
                                        <li class='nav-item '>
                                            <a class='dropdown-item '
                                ...
                                <li class='nav-item dropdown'><a href='#'
                                    ...
                                    <ul class='dropdown-menu'>
                                        @forelse ($form_categories as $item)
                                            <li><a class='dropdown-item'
                                                    href="{{ route('form', ['language' => $current_language, 'slug' => $item->slug]) }}">{{ $item->title }}</a>
                                            </li>
                                        @empty
                                            <li><a class='dropdown-item' href="#">Fomu hazipo kwa sasa</a>
                                            </li>
                                        @endforelse
                                    </ul>
                                </li>
                                ...
                                <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                    ...
                                    <ul class='dropdown-menu'>
                                        @forelse ($publication_categories as $item)
                                            <li><a class='dropdown-item'
