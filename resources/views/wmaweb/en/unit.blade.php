                    ...
                    <div class="col-12 px-xs-0 px-1">
                        <nav aria-label="breadcrumb" class="mb-0">
                            <ol class="breadcrumb px-0">
                                ...
                                <li class="breadcrumb-item list-inline-item active">Unit</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-12 px-0 mt-4 justify-content-center align-items-center">
                            <p class="unit">
                               ...
                               <h5>1.Legal Unit</h5>
                                   ...
                                   - Provide advise on matters arising from regional and International affiliation in relation to legal metrology laws<br>
                                   - Liaise with the office of Attorney General on appearance in court and quasi-judicial bodies<br><br>
                               ...
                               <h5>2. Planning, Monitoring and Evaluation Unit</h5>
                                        ...
                                        -Coordinate preparations of Quarterly, Mid - year and Annual performance reports (Periodic reports)<br>
                                       - Coordinate the formulation and implementation of Development Projects<br><br>


                               <h5>3.Procurement Unit</h5>
                                    -Manage all procurement and disposal by tender activities except adjudication and award of contract<br>
