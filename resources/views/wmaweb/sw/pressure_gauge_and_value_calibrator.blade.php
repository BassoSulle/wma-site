            ...
            <div class="col-12 py-4 px-0">
                    ...
                    <div class="col-12 px-xs-0 px-1">
                        <nav aria-label="breadcrumb" class="mb-0">
                            <ol class="breadcrumb px-0">
                                ...
                                <li class="breadcrumb-item list-inline-item active">Wapimaji wa vipimo vya Mgandamizo
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 bg-white py-3 page-content">
                        <h4>Wapimaji wa vipimo vya Mgandamizo (Pressure gauges & Valves Calibrators)</h4>
