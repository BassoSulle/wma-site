...
<head>
    ...
    <!-- App css -->
    <link href="{{asset('asset/css/app.min.css')}}" rel="stylesheet" type="text/css" id="light-style">
    <link href="{{asset('asset/css/icons.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('asset/css/app-dark.min.css')}}" rel="stylesheet" type="text/css" id="dark-style">
    <style>
        .error{
            color: red
        }
...
{{--                        <img src="{{asset('assets/images/logo.jpeg')}}" alt="">--}}
        ...
        <a href="" class="logo text-center logo-dark">
                    <span class="logo-lg">
                       <img src="{{ asset('static/asset/images/logo.png') }}" alt="TIRDO Logo" class="image mr-4 rounded-3" width="25">
                        WMA
                    </span>
            <span class="logo-sm">
                        WMA
...
<!-- third party js -->
<script src="{{asset('asset/js/vendor/Chart.bundle.min.js')}}"></script>
<script src="{{asset('asset/js/vendor/apexcharts.min.js')}}"></script>
<script src="{{asset('asset/js/vendor/smooth-scrollbar.js')}}"></script>
