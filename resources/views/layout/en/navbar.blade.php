                    ...
                    <div class="col-7 sm-hide px-0">
                        <ul class="list-inline mx-auto justify-content-end">
                            ...
                            <li class='nav-item'><a class='nav-link' target='_black'
                                    href='https://mail.tirdo.or.tz' style="color: white">Staff Mail</a></li>
                            </li>
                            <li class='nav-item'><a class='nav-link' target='_black'
                                    href='https://eoffice.gov.go.tz/users/login' style="color: white">e-Office</a></li>
                            </li>
                            <li class='nav-item'><a class='nav-link'
                                 href="{% url 'faq' current_language %}" style="color: white">FAQs</a></li>
                            </li>
                            <li class='nav-item'><a class='nav-link' href='#' style="color: white">help@tirdo.or.tz</a></li>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid px-0">
                <div class="row ">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8 text-center pt-4 pt-xs-0">
                        <h2 class="mb-0 title title-main" style="color: #1e4594">TANZANIA INDUSTRIAL RESEARCH AND DEVELOPMENT ORGANIZATION </h2>
                        <h6 class="title-desc pt-2" style="color: black"><b><i>TIRDO for sustainable industrial development</i></b></h6>
                    </div>
