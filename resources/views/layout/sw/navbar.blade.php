                        ...
                        <ul class="list-inline mx-auto float-left">
                            ...
                            <li class="list-inline-item sm-hide pr-2">
                                <div class="footer-media">
                                    <a href="https://www.facebook.com/Weights-and-Measures-Agency-Tanzania-WMA-1379267282334120/"
                                        target="_blank"><img
                                            src="https://img.icons8.com/?size=100&id=106163&format=png&color=000000"
                                            style="filter: brightness(0) invert(1); width: 18px;" /></a>

                                    <a href="https://www.instagram.com/wakalawavipimotanzania/" target="_blank"><img
                                    ...
                                    <a href="https://twitter.com/vipimotz" target="_blank"><img
                                            ...
                                            style="filter: brightness(0) invert(1);" /></a>
                                    <a href="https://www.youtube.com/channel/UCNEm7cYfD0siW92mnI_pwzg"
                                        target="_blank"><img
                                            src="https://img.icons8.com/?size=100&id=37326&format=png&color=000000"
                                            style="filter: brightness(0) invert(1); width: 26px;" /></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="collapse navbar-collapse col-12 px-0" id="middleNavbarMenu">
                        <ul class="navbar-nav mr-auto nav-bottom-header justify-content-center d-flex col-12">
                            ...
                            <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                ...
                                <ul class='dropdown-menu'>
                                    <li><a class='dropdown-item'
                                            href="{{ route('background', ['language' => $current_language]) }}">Historia</a>
                                    </li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('vision-and-mission', ['language' => $current_language]) }}">Dira
                                            na Dhamira</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('core-value', ['language' => $current_language]) }}">Misingi
                                            Mikuu</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('mandate-and-role', ['language' => $current_language]) }}">Majukumu
                                            ya Wakala wa Vipimo</a></li>
                            ...
                            <li class='nav-item dropdown'><a href='#'
                                    class='nav-link dropdown-toggle'data-toggle='dropdown'>Utawala</a>
                                <ul class='dropdown-menu'>
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('organization-structure', ['language' => $current_language]) }}'>Muundo
                                            wa taasisi </a>
                                        {{-- <ul class='dropdown-menu'> --}}
                                        {{-- <li><a class='dropdown-item'
                                            ...
                                            <li><a class='dropdown-item'
                                                    href="{{ route('foodbiotechnology', ['language' => $current_language]) }}">Food
                                                    and Biotechnology</a></li>
                                            <li><a class='dropdown-item'
                                                    href="{{ route('industrialchemistry', ['language' => $current_language]) }}">Industrial
                                                    Chemistry</a></li> --}}
                                        {{-- </ul> --}}
                                    </li>
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('directorate', ['language' => $current_language]) }}'>Kurugenzi
                                        </a>
                                    </li>
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('section', ['language' => $current_language]) }}'>Sehemu
                                        </a>
                                    </li>
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('unit', ['language' => $current_language]) }}'>VItengo </a>
                                    </li>
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('board-member', ['language' => $current_language]) }}'>Wajumbe
                                            wa Bodi ya Ushauri kwa Wizara
                                    <li class='nav-item '>
                                        <a class='dropdown-item '
                                            href='{{ route('wma-management', ['language' => $current_language]) }}'>Menejimenti
                                            ya Wakala wa Vipimo</a>
                                    </li>
                                </ul>
                            </li>
                            <li class='nav-item dropdown'><a href='#'
                                    class='nav-link dropdown-toggle'data-toggle='dropdown'>Wadau wa Taaluma</a>
                                <ul class='dropdown-menu'>
                                    <li class='nav-item '>
                                    <li><a class='dropdown-item'
                                            href="{{ route('pump-technician', ['language' => $current_language]) }}">Mafundi
                                            Pampu</a>
                                    </li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('scale-mechanics', ['language' => $current_language]) }}">Mafundi
                                            Mizani</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('tank-calibrator', ['language' => $current_language]) }}">Wapimaji
                                            Matenki yanayotumika Kuhifandhia Mafuta</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('gas-metre-calibrator', ['language' => $current_language]) }}">Wapimaji
                                            wa Mita za Gesi</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('scale-manufacture', ['language' => $current_language]) }}">Waunda
                                            Mizani</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('tank-constructor', ['language' => $current_language]) }}">Waundaji
                                            wa Matenki</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('pressure-gauge-and-value-calibrator', ['language' => $current_language]) }}">Wapimaji
                                            wa Vipimo vya Mgandamizo (Pressure
                                            gauges & Values)
                                            Calbrators</a></li>
                                    <li><a class='dropdown-item'
                            ...
                            <li class='nav-item dropdown'><a href='#'
                                    class='nav-link dropdown-toggle'data-toggle='dropdown'>Fomu</a>
                                <ul class='dropdown-menu'>
                                    <li><a class='dropdown-item'
                                            href="{{ route('application-form-for-tank-calibrator', ['language' => $current_language]) }}">Fomu
                                            ya maombi kwa wapimaji wa matenki</a>
                                    </li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('form-d-for-pump-mechanics', ['language' => $current_language]) }}">Fomu
                                            D kwa ajili ya Mafundi Pumps</a>
                                    </li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('application-form-for-licencing-scale', ['language' => $current_language]) }}">Fomu
                                            ya maombi ya leseni ya ufundi Mizani/Pampu</a>
                                    </li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('compounding-form', ['language' => $current_language]) }}">Fomu
                                            ya Ufifilishaji</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                ...
                                <ul class='dropdown-menu'>
                                    ...
                                    <li><a class='dropdown-item' href="#">Taarifa kwa Vyombo vya Habari</a></li>
                            ...
                            <li class='nav-item dropdown'><a
                                    href='{{ route('tender', ['language' => $current_language]) }}'
                                    class='nav-link'>Zabuni</a>
                            </li>
                            <li class='nav-item dropdown'><a
                                    href='{{ route('regional-office', ['language' => $current_language]) }}'
                                    class='nav-link'>Ofisi za Mikoa</a>

                            </li>
                            <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                    data-toggle='dropdown'>Ripoti ya Ukaguzi</a>
                                <ul class='dropdown-menu'>
                                    <li><a class='dropdown-item'
                                            href="{{ route('audit-report-2018-2019', ['language' => $current_language]) }}">Ripoti
                                            ya Ukaguzi 2018-2019</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('audit-report-2019-2020', ['language' => $current_language]) }}">Ripoti
                                            ya Ukaguzi 2019-2020</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('audit-report-2020-2021', ['language' => $current_language]) }}">Ripoti
                                            ya Ukaguzi 2020-2021</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('audit-report-2021-2022', ['language' => $current_language]) }}">Ripoti
                                            ya Ukaguzi 2021-2022</a></li>
                                    <li><a class='dropdown-item'
                                            href="{{ route('audit-report-2022-2023', ['language' => $current_language]) }}">Ripoti
                                            ya Ukaguzi 2022-2023</a></li>
                                </ul>
                            </li>
                            <li class='nav-item dropdown'><a
                            ...
                            {{-- <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                ...
                                <ul class='dropdown-menu'>
                                    ...
                                    <li><a class='dropdown-item' href='https://mail.tirdo.or.tz'
                                    ...
                                    <li><a class='dropdown-item'
                                            href='https://safari.gov.go.tz/index.php/user/auth/login'
                            ...
                            <li class='nav-item dropdown'><a href='#' class='nav-link dropdown-toggle'
                                ...
                                <ul class='dropdown-menu'>
                                    <li><a class="dropdown-item"
                                            href="{{ route('weight-and-measure-act', ['language' => $current_language]) }}">Sheria
                                            ya Vipimo</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('wma-regulation', ['language' => $current_language]) }}">Kanuni</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('approved-pattern', ['language' => $current_language]) }}">Vipimo
                                            vilivyoidhinishwa</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('miscalleneous-amendment-act', ['language' => $current_language]) }}">Marekebisho
                                            ya Sheria</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('technical-manual', ['language' => $current_language]) }}">Miongozo
                                            ya Kiufundi</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('establishment-order', ['language' => $current_language]) }}">Miongozo
                                            ya Kisheria</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('framework-document', ['language' => $current_language]) }}">Framework
                                            Documents</a>
                                    <li><a class="dropdown-item"
                                            href="{{ route('client-service-charter', ['language' => $current_language]) }}">Mkataba
                                            wa huduma kwa mteja</a>
                                    </li>
                                </ul>
                            </li>
