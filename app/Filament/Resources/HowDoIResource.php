...
use App\Filament\Resources\HowDoIResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\HowDoIResource\RelationManagers;

class HowDoIResource extends Resource
{
    protected static ?string $model = HowDoI::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    // name to be used in navigation
    protected static ?string $navigationLabel = 'How Do I';

    // position of the resource in navigation
    protected static ?int $navigationSort = 4;

    // name to be used in page titles
    protected static ?string $modelLabel = 'How Do I';
    ...
    protected static ?string $slug = 'how_do_i';
                                ...
                                Tabs\Tab::make('English')
                                    ->schema([
                                        ...
                                        TextInput::make('slug')
                                            ...
                                            ->dehydrated()
                                            // ->hidden()
                                            ->unique(HowDoI::class, 'slug', ignoreRecord: true),
    ...
    {
        return [
            'index' => Pages\ListHowDoIS::route('/'),
            'create' => Pages\CreateHowDoI::route('/create'),
            'edit' => Pages\EditHowDoI::route('/{record}/edit'),
        ];
    }
}
