...
use App\Filament\Resources\BrochuresResource\Pages;
use App\Filament\Resources\BrochuresResource\RelationManagers;
...
class BrochuresResource extends Resource
{
    protected static ?string $model = Brochures::class;
    ...
    protected static ?string $modelLabel = 'Brochures';
    ...
    protected static ?string $slug = 'brochures';
                            ...
                            Tabs\Tab::make('English')
                                ->schema([
                                    TextInput::make('en_title')
                                        ...
                                        ->dehydrated()
                                        // ->hidden()
                                        ->unique(Brochures::class, 'slug', ignoreRecord: true),


                                    FileUpload::make('en_file')
                                        ->label('PDF Document')
                                        ->required()
                                        ->directory('brochures/en')
                                        ->acceptedFileTypes(['application/pdf']),
                                ])
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateBrochures::route('/create'),
            'edit' => Pages\EditBrochures::route('/{record}/edit'),
        ];
    }
}
